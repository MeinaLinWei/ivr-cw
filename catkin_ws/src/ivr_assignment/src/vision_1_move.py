...
# Defines subscribers
    def __init__(self):
        ...
        rospy.init_node('vision_1_move', anonymous=True)
        # initialise a publisher to send the next joint 1 position to joint1_position_controller
        self.joint_pub2 = rospy.Publisher( "/robot/joint2_position_controller/command", Float64, queue_size = 10)
        ...
        self.nextPositionJoint2 = Float64()
